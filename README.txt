...
2-) After Node js is installed, we unrar our bot, then enter the databases folder. You can open it with notepad or visual studio to make it cool. It doesn't matter. Then enter the Data base > db.json file and fill in the required fields.
